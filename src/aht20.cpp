...
bool aht20_setup (i2c_inst_t *i2c) {
  uint8_t data[2];
  i2c_reg_read(i2c, AHT20_ADDRESS, AHT20_REG_STATUS, data, 1);
  ...
  if ((data[0]&(1<<3)) == 0) {
    ...
    i2c_reg_write(i2c, AHT20_ADDRESS, AHT20_INIT, data, 2);
  }
...
bool aht20_measure(i2c_inst_t *i2c, uint32_t *temperature, uint32_t* humidity) {
  ...
  i2c_reg_write(i2c, AHT20_ADDRESS, AHT20_TRIG, data, 2);
  sleep_ms(100);
  do {
    i2c_reg_read(i2c, AHT20_ADDRESS, AHT20_REG_STATUS, data, 1);
